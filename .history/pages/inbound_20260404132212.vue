...
// 6. Fungsi untuk mengeksekusi pengiriman data (Akan dikerjakan di tahap selanjutnya)
const submitInbound = async () => {
  console.log('Data siap dikirim ke Laravel:', form.value)
  alert('Form berfungsi! Cek Console Browser (F12) untuk melihat data yang siap dikirim.')
  // Nanti kita tambahkan kode $fetch POST ke Laravel di sini
}
</script>